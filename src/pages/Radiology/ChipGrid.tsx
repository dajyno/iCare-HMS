...
const ChipGrid = ({ label, selected, onToggle }: ChipGridProps) => {
  return (
    <motion.button
      type="button"
      onClick={onToggle}
      layout
      className={`relative w-full text-left px-3 py-2 rounded-lg text-[13px] font-medium border transition-colors cursor-pointer ${
        selected
