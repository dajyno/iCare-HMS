...
drop table if exists public.radiology_results cascade;
drop table if exists public.radiology_requests cascade;
drop table if exists public.radiology_exams cascade;
drop table if exists public.radiology_categories cascade;
...
create table public.users (
  ...
  phone         text,
  role          text not null check (role in ('SuperAdmin','HospitalAdmin','ChiefMedicalOfficer','Doctor','Nurse','LabTechnician','Pharmacist','Radiologist','Accountant','FrontDesk','Administrator')),
  department_id uuid,
